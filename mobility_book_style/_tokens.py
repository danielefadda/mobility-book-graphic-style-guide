"""
Design tokens semantici - NON modificabili dall'utente.

I design tokens definiscono la semantica dei colori e delle dimensioni
utilizzate nelle visualizzazioni. Sono costruiti a partire dalla palette
primitiva ALIAS_COLORS.

Importante:
    Questi valori sono immutabili e non devono essere modificati dall'utente.
    Per garantire coerenza visiva, lo stile è centralizzato e bloccato.
"""

from ._colors import ALIAS_COLORS


# Conversion utility (Matplotlib uses pt, web uses px)
...
# Design tokens principali (immutabili)
TOKENS = {
    "font": {
    ...
    "chart": {
        ...
        "line_width": 2.0,
        "category10": [
            ALIAS_COLORS["blue-60"],
            ALIAS_COLORS["gray-70"],
            "#1A1A1A",
            ALIAS_COLORS["gray-50"],
            "#333333",
            ALIAS_COLORS["gray-30"],
            "#4D4D4D",
            "#C9C9C9",
            "#666666",
            "#DCDCDC",
    ...
    # Stile TABELLE (Inter) – ispirato a Urban Institute, adattato
    "table": {
        # tipografia (px)
